...
export function PracticalScreen({ onBack }:{ onBack:()=>void }) {
  const SECTIONS = [
    { title:"Валюта и деньги",  icon:"💱",color:"#C17B2F",items:["Курс смотрите в конвертере выше — он живой","Обменивайте в банках или обменниках","Карты принимают в крупных отелях","Наличные нужны для рынков и кафе"] },
