...
export function SplashScreen({ onStart, onLogin }:{ onStart:()=>void; onLogin:()=>void }) {
  ...
  return (
    <div className="flex flex-col h-full relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center gap-3 px-6 pt-16"><LogoMark size={44} intro tone="#ffffff"/><div><p className="text-white text-2xl font-bold leading-none" style={{fontFamily:"'Fraunces',serif",textShadow:"0 2px 12px rgba(0,0,0,0.55)"}}>UzRoam</p><p className="text-white text-xs mt-1 font-medium" style={{textShadow:"0 1px 8px rgba(0,0,0,0.6)"}}>{t("splash_tagline")}</p></div></div>
