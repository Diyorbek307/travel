...
export function SplashScreen({ onStart, onLogin }:{ onStart:()=>void; onLogin:()=>void }) {
  ...
  return (
    <div className="flex flex-col h-full relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center gap-3 px-6 pt-16"><LogoMark size={44}/><div><p className="text-white text-2xl font-bold leading-none" style={{fontFamily:"'Fraunces',serif"}}>UzUp</p><p className="text-white/70 text-xs mt-0.5">{t("splash_tagline")}</p></div></div>
