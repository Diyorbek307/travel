...
export function SideMenu({ onClose, onTab, currentTab, isPremium, onPremium, onLogout, onFavorites,
  ...
  return (
    <>
      ...
      <div className="absolute top-0 left-0 bottom-0 z-50 flex flex-col slide-in-left" style={{width:290,background:SURFACE}}>
        {/* Header */}
        <div className="px-5 pt-14 pb-5 border-b" style={{borderColor:BORDER}}>
          <div className="flex items-center justify-between mb-5">
            ...
            <button onClick={onClose} className="w-8 h-8 rounded-xl flex items-center justify-center" style={{background:CREAM}}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={TEXT} strokeWidth="2.5"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
            </button>
          </div>
          {/* User */}
