...
const ROLES: Role[] = [
  {
    id: 1,
    name: "Суперадмин",
    desc: "Полный доступ ко всем функциям и настройкам",
    color: "var(--color-amber)",
    users: 1,
    permissions: Object.fromEntries(MODULES.map((m) => [m, "full"])) as Record<
      string,
      "full" | "read" | "none"
    >,
  },
  {
    ...
    desc: "Управляет турами, направлениями, отелями и событиями",
  ...
  },
  {
    ...
    desc: "Обрабатывает обращения клиентов и вопросы бронирований",
    color: "#7a8fff",
    users: 5,
    permissions: {
      Дашборд: "read",
  ...
  },
  {
    ...
    desc: "Доступ только к финансовым отчётам и счетам",
...
const ADMIN_USERS: AdminUser[] = [
  ...
  {
    id: 2,
    name: "Камола Ташкентова",
    email: "kamola@hellouz.uz",
  ...
  {
    id: 3,
    name: "Сардор Исмоилов",
    email: "sardor@hellouz.uz",
    role: "Менеджер контента",
  ...
  {
    id: 7,
    name: "Зулфия Эргашева",
    email: "zulfiya@hellouz.uz",
  ...
  },
  {
    id: 8,
    name: "Алишер Нишанов",
    email: "alisher@hellouz.uz",
    role: "Финансовый менеджер",
    lastActive: "4 ч назад",
    status: "active",
    avatar: "АН",
    twofa: true,
  },
...
export default function AccessControl() {
  ...
  const roleColor = (roleName: string) =>
    ROLES.find((r) => r.name === roleName)?.color ?? "var(--color-muted)";
    ...
    <div className="p-4 sm:p-7">
      ...
      {tab === "roles" && (
        <div className="flex flex-col gap-6 lg:flex-row">
            ...
            {ROLES.map((r) => (
              ...
              >
                ...
                <div className="text-xs" style={{ color: "var(--color-muted)" }}>
                  {r.users} {r.users === 1 ? "пользователь" : "пользователей"}
                </div>
              </button>
            ))}
          </div>
          ...
          {selectedRole && (
            <div
              className="min-w-0 flex-1 rounded-2xl overflow-hidden"
                ...
                <table className="w-full min-w-[34rem]">
                  <thead>
                    ...
                    >
                      ...
                      <th
                        className="text-center px-4 py-2.5 text-xs font-medium"
                        style={{ color: "var(--color-muted)", fontFamily: "var(--font-mono)" }}
                      >
                        ДОСТУП
                      </th>
                      <th
                        className="text-center px-4 py-2.5 text-xs font-medium w-24"
                        style={{ color: "var(--color-muted)", fontFamily: "var(--font-mono)" }}
                      >
                        УРОВЕНЬ
                      </th>
                  ...
                  <tbody>
                    {MODULES.map((mod, i) => {
                      ...
                      return (
                        ...
                        >
                          <td className="px-4 py-2.5 text-sm" style={{ color: "var(--color-text)" }}>
                            {mod}
                          </td>
                          <td className="px-4 py-2.5 text-center">
                            <span
                              ...
                              style={{
                                background: мягко(PERM_COLORS[perm], 13),
                            ...
                            <div className="flex flex-wrap justify-center gap-1">
                              {(["full", "read", "none"] as const).map((level) => (
                                <div
                                  ...
                                  style={{
                                    background: perm === level ? PERM_COLORS[level] : "var(--color-dim)",
                                  }}
                                />
                              ))}
                            </div>
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5 flex-wrap">
                  ...
                  <span
                    ...
                    style={{
                      background: мягко(roleColor(u.role), 13),
              ...
              {(
                ...
                <div key={k}>
                  ...
                  <input
                    ...
                    value={inviteForm[k as keyof typeof inviteForm]}
                    onChange={(e) => setInviteForm((p) => ({ ...p, [k]: e.target.value }))}
              ...
              <div>
                ...
                <div className="flex flex-col gap-1.5">
                  {ROLES.map((r) => (
                    <button
                      key={r.name}
                      onClick={() => setInviteForm((p) => ({ ...p, role: r.name }))}
                      className="rounded-lg px-3 py-2.5 text-left cursor-pointer transition-all"
                      style={{
                        background: inviteForm.role === r.name ? мягко(r.color, 13) : "var(--color-surface)",
                        border: `1px solid ${inviteForm.role === r.name ? r.color : "var(--color-border)"}`,
                      }}
                    >
                ...
                {[
                  {
                    time: "09:42",
                    admin: "Рустам М.",
                    action: "Обновил цены тура",
                    target: "Silk Road Heritage",
                    ip: "91.185.xx.xx",
                  },
                  {
                    time: "09:38",
                    admin: "Камола Т.",
                    action: "Опубликовала страницу города",
                    target: "Наманган",
                    ip: "37.110.xx.xx",
                  },
                  {
                  ...
                  },
                  {
                    time: "Вчера",
                    admin: "Зулфия Э.",
                    action: "Экспортировала финансовый отчёт",
                    target: "Август 2026",
                    ip: "46.8.xx.xx",
                  },
                  {
                    time: "Вчера",
                    admin: "Камола Т.",
                    action: "Удалила событие",
                    target: "Fergana Spring Fest",
                    ip: "37.110.xx.xx",
                  },
                  {
                    time: "2 д назад",
                    admin: "Дилшод К.",
                    action: "Ошибка входа (3 попытки)",
                    target: "—",
                    ip: "176.221.xx.xx",
                  },
                  {
                  ...
                  >
                    ...
                    <td className="px-4 py-2.5" style={{ color: "var(--color-amber)", fontSize: "13px" }}>
                      {row.admin}
                    </td>
                    <td className="px-4 py-2.5" style={{ color: "var(--color-text)", fontSize: "13px" }}>
                      {row.action}
                    </td>
                    <td className="px-4 py-2.5" style={{ color: "var(--color-muted)", fontSize: "13px" }}>
                      {row.target}
                    </td>
                    <td
                      className="px-4 py-2.5"
