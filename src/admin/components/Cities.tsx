  ...
  return (
    <div className="p-4 sm:p-7">
        ...
        {filtered.map((city) => (
          <div
            ...
            style={{
              ...
              border: `1px solid ${city.featured ? "rgba(212,135,42,0.5)" : "var(--color-border)"}`,
            }}
          ...
          >
            <div className="relative h-44 overflow-hidden" style={{ background: "var(--color-dim)" }}>
              ...
              <div
                ...
                style={{ background: "linear-gradient(to top, rgba(13,12,10,0.9) 0%, transparent 60%)" }}
              />
            ...
            <div className="p-4">
              ...
              >
                ...
                <span style={{ color: "var(--color-teal)" }}>
                  {city.tourists.toLocaleString()} туристов/год
                </span>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                <Btn
                  variant={city.featured ? "danger" : "ghost"}
                  small
                  onClick={(e) => {
                    e.stopPropagation();
                    toggleFeatured(city.id);
                  }}
                >
            ...
            <div className="flex flex-col gap-3 mb-4">
              {(
                ...
                <div key={k}>
                  ...
                  <input
                    type={type}
                    value={newCity[k as keyof typeof newCity]}
                    onChange={(e) => setNewCity((p) => ({ ...p, [k]: e.target.value }))}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setNewCity((p) => ({ ...p, description: e.target.value }))}
                ...
                onClick={() => {
                  ...
                  setCities((prev) => [
                    ...prev,
                    {
                      ...
                      population: Number(newCity.population) || 0,
                      tourists: Number(newCity.tourists) || 0,
                      highlights: [],
                      description: newCity.description || "",
                      status: "draft" as const,
                      featured: false,
                      sub: newCity.region || "Узбекистан",
                      rating: 0,
      ...
      {selected && draft && (
        ...
        >
          <div
            className="rounded-xl w-full max-w-lg overflow-hidden max-h-[90dvh] overflow-y-auto"
            style={{ background: "var(--color-panel)", border: "1px solid var(--color-border)" }}
            onClick={(e) => e.stopPropagation()}
          >
            <div className="relative h-44" style={{ background: "var(--color-dim)" }}>
              ...
              <button
                className="absolute top-4 right-4 text-white text-xl opacity-60 hover:opacity-100 cursor-pointer"
                onClick={() => setSelected(null)}
              >
                ×
              </button>
            ...
            <div className="p-5">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Btn
                  variant={draft.featured ? "danger" : "ghost"}
                  onClick={() => {
                    toggleFeatured(draft.id);
                    setSelected(null);
                  }}
                >
