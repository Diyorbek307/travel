...
const SEED: NotifItem[] = [
  {
    ...
    body: "Ахмед Халил забронировал тур «Шёлковый путь» (3 чел.) — $2,430",
    type: "booking",
    time: "2 мин назад",
    read: false,
    user: "Ахмед Халил",
  ...
  {
    id: 2,
    title: "Получена оценка 5 звёзд",
    body: "Мария Чен оставила отзыв на тур «Самарканд за день»",
    type: "review",
    time: "14 мин назад",
    read: false,
    user: "Мария Чен",
  ...
  },
  {
    id: 3,
    title: "Ошибка оплаты",
    body: "Карта отклонена для Софи Бернхард — тур «Бухара 3 дня» ($1,260)",
    type: "payment",
    time: "1 ч назад",
    read: false,
    user: "Софи Бернхард",
  ...
  {
    id: 4,
    title: "Заявка гида на рассмотрении",
    body: "Амир Ахмедов подал документы для сертификации гида",
    type: "system",
    time: "2 ч назад",
    read: false,
    action: "Проверить",
  },
  {
    id: 5,
    title: "Мало мест",
    body: "Лагерь «Закат в пустыне» (2–5 сен) — остался 1 слот",
    type: "alert",
    time: "3 ч назад",
    read: true,
    action: "Тур",
  },
  {
    ...
    body: "Юки Танака: «Письмо с подтверждением отеля не пришло...»",
    type: "chat",
    time: "4 ч назад",
    read: true,
    user: "Юки Танака",
  ...
  {
    id: 7,
    title: "Срок промокода истекает",
    body: "SILKROAD20 истекает через 3 дня — осталось 376 использований",
    type: "system",
    time: "5 ч назад",
    read: true,
    action: "Продлить",
  },
  {
    ...
    body: "Баннер Uzbekistan Airways — 12 400 показов",
    type: "payment",
    time: "1 д назад",
    read: true,
    action: "Отчёт",
  },
  {
    ...
    body: "Джеймс Уокер (Великобритания) зарегистрировался и сделал первое бронирование",
    type: "booking",
    time: "1 д назад",
    read: true,
    user: "Джеймс Уокер",
  },
  {
    ...
    body: "Ежедневный бэкап выполнен — 2.4 ГБ, всё в норме",
    type: "system",
    time: "2 д назад",
    read: true,
  },
  {
    ...
    body: "Дмитрий Волков отменил тур «Хива» — возврат $320",
    type: "payment",
    time: "2 д назад",
    read: true,
    user: "Дмитрий Волков",
  ...
  {
    id: 12,
    title: "Отмечен негативный отзыв",
    body: "Оценка 1★ для Hotel Malika Bukhara требует модерации",
    type: "alert",
    time: "3 д назад",
    read: true,
    action: "Модерация",
    ...
    <div className="p-4 sm:p-7">
      ...
      <div className="flex flex-col gap-6 lg:flex-row">
        ...
        {selected ? (
          <div className="w-full shrink-0 lg:w-72">
            ...
            >
              <div
                ...
                style={{
                  background: мягко(TYPE_COLORS[selected.type], 13),
              ...
              <Badge
                label={selected.type}
                color={
                  selected.type === "booking" || selected.type === "review"
                    ? "teal"
                    : selected.type === "payment" || selected.type === "alert"
                    ? "rose"
                    : "dim"
                }
              />
              ...
              <div
                className="flex flex-col gap-2 text-xs mb-5"
              ...
              <div className="flex flex-col gap-2">
                ...
                <Btn variant="danger" onClick={() => deleteNotif(selected.id)}>
                  Удалить
                </Btn>
              </div>
            </div>
          ...
          <div
            className="w-full shrink-0 rounded-2xl lg:w-72 flex items-center justify-center text-center p-8"
