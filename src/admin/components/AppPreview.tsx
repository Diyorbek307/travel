        ...
        <div className="flex min-w-0 flex-1 flex-col gap-4">
          ...
          >
            ...
            <ul className="flex flex-col gap-2 text-xs" style={{ color: "var(--color-muted)" }}>
              <li>
                <span style={{ color: "var(--color-amber)" }}>◈</span> Города, места, отели, рестораны и
                реклама — те самые, что заведены в разделах панели.
              </li>
              <li>
                <span style={{ color: "var(--color-teal)" }}>↑</span> После правки нажмите «Обновить» —
                приложение перечитает содержимое.
              </li>
              <li>
                <span style={{ color: "var(--color-amber)" }}>☾</span> Переключатель темы показывает, как
                приложение выглядит у человека со светлой и с тёмной настройкой телефона.
              </li>
            </ul>
          </div>
          ...
          >
            Это настоящая страница приложения, а не картинка: по ней можно кликать. Вход и регистрация внутри
            рамки работают как обычно — превью открывает приложение от имени гостя.
          </div>
        </div>
      </div>
    </div>
