...
export const ADS = [
  ...
  { id:"a6", emoji:"🥤", label:"РЕКЛАМА", title:"Anor Cola",        sub:"Освежись в жару — ищи в магазинах рядом.", cta:"На сайт", color:"#C0392B", city:"", url:ДЕМО_САЙТ, imageUrl:"https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=240&h=240&fit=crop&auto=format", videoUrl:"/videos/coke-ad.mp4", skipAfter:5 },
