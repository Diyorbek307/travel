 ...
 * его карточку, — по id места, а не по городу: раньше любое место в
 * Самарканде сразу давало все три самаркандских штампа.
 */
export const STAMPS = [
  { name:"Регистан",   placeId:"reg",   icon:"🕌" },
  { name:"Шахи-Зинда", placeId:"shah",  icon:"☪️" },
  { name:"Гур-э-Амир", placeId:"gur",   icon:"🏛️" },
  { name:"Арк Бухары", placeId:"ark",   icon:"🏰" },
  { name:"Ичан-Кала",  placeId:"ikhon", icon:"🗼" },
  { name:"Хаст-Имам",  placeId:"hastm", icon:"🕌" },
];
/**
