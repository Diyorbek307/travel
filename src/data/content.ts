...
export const NOTIFS = [
  ...
  { emoji:"🏷️",title:"Скидка 15% на отели",body:"Код UZROAM15 при бронировании через приложение.",time:"3 ч назад",unread:false },
...
export const ADS = [
  ...
  { id:"a1", emoji:"🏨", label:"РЕКЛАМА", title:"Registan Plaza Hotel",     sub:"Скидка 20% при бронировании через UzRoam",  cta:"Забронировать", color:"#1B6B8A", city:"Самарканд", url:ДЕМО_САЙТ, imageUrl:"https://images.unsplash.com/photo-1566073771259-6a8506099945?w=240&h=240&fit=crop&auto=format" },
