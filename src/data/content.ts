...
export const ADS = [
  ...
  { id:"a1", emoji:"🏨", label:"РЕКЛАМА", title:"Registan Plaza Hotel",     sub:"Скидка 20% при бронировании через UzRoam",  cta:"Забронировать", color:"#1B6B8A", city:"Самарканд", url:ДЕМО_САЙТ },
  { id:"a2", emoji:"🍽️", label:"РЕКЛАМА", title:"Плов-центр Ташкента",      sub:"Лучший плов с 1978 года. Откройте для себя!", cta:"Смотреть меню", color:"#C1603A", city:"Ташкент",   url:ДЕМО_САЙТ },
  { id:"a3", emoji:"✈️", label:"РЕКЛАМА", title:"Afrosiyob Air",            sub:"Прямые рейсы из Самарканда. От $149",         cta:"Купить билет",  color:"#13544C", city:"Самарканд", url:ДЕМО_САЙТ },
  { id:"a4", emoji:"🛍️", label:"РЕКЛАМА", title:"Silk & Spice Bazaar",       sub:"Аутентичные сувениры прямо от мастеров",      cta:"Перейти",       color:"#7B4F9E", city:"Бухара",   url:ДЕМО_САЙТ },
  { id:"a5", emoji:"🚌", label:"РЕКЛАМА", title:"Samarkand Tour Transfers",  sub:"Трансфер аэропорт–город от $8",               cta:"Заказать",      color:"#0E6F66", city:"Самарканд", url:ДЕМО_САЙТ },
  // Товары — без города: показываются в любом месте поездки.
  { id:"a6", emoji:"🥤", label:"РЕКЛАМА", title:"Anor Cola",        sub:"Освежись в жару — ищи в магазинах рядом.", cta:"На сайт", color:"#C0392B", city:"", url:ДЕМО_САЙТ },
  { id:"a7", emoji:"🧃", label:"РЕКЛАМА", title:"Chashma Juice",    sub:"Гранатовый сок из Ферганской долины.",     cta:"На сайт", color:"#1B6B8A", city:"", url:ДЕМО_САЙТ },
  { id:"a8", emoji:"💧", label:"РЕКЛАМА", title:"Oqsuv",            sub:"Чистая вода в дорогу.",                    cta:"На сайт", color:"#0072CE", city:"", url:ДЕМО_САЙТ },
];
