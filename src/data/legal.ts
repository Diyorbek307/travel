...
const TERMS: Три = {
  ru:
    "Условия использования HelloUZ\n\n" +
    "HelloUZ — справочно-туристическое приложение об Узбекистане: места, маршруты, аудиогиды, карты и погода.\n\n" +
    ...
    "2. Бронирования и билеты оформляются у сторонних поставщиков (отели, перевозчики, такси). HelloUZ лишь передаёт вас к ним и не является стороной сделки.\n\n" +
  ...
  en:
    "HelloUZ Terms of Use\n\n" +
    "HelloUZ is an informational travel app about Uzbekistan: places, routes, audio guides, maps and weather.\n\n" +
    ...
    "2. Bookings and tickets are handled by third-party providers (hotels, carriers, taxi). HelloUZ only forwards you to them and is not a party to the deal.\n\n" +
  ...
  uz:
    "HelloUZ foydalanish shartlari\n\n" +
    "HelloUZ — Oʻzbekiston haqidagi maʼlumot-sayohat ilovasi: joylar, marshrutlar, audiogidlar, xaritalar va ob-havo.\n\n" +
    ...
    "2. Bandlar va chiptalar uchinchi tomon yetkazib beruvchilarda (mehmonxona, tashuvchi, taksi) rasmiylashtiriladi. HelloUZ faqat sizni ularga yoʻnaltiradi.\n\n" +
...
const PRIVACY: Три = {
  ru:
    "Политика конфиденциальности HelloUZ\n\n" +
