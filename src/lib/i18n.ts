...
export const СЛОВАРЬ = {
  ...
  ex_vr_sub: row("Ancient cities in VR — coming soon", "Древние города в VR — скоро", "VRda qadimiy shaharlar — tez orada", "VR中的古城——即将推出", "VR 속 고대 도시 — 곧 출시", "Antike Städte in VR — bald verfügbar", "Villes antiques en RV — bientôt disponible", "VRで古代都市を体験 — 近日公開", "VR'de antik şehirler — yakında", "مدن قديمة بالواقع الافتراضي — قريبًا"),
  ex_soon_badge: row("Coming soon", "В разработке", "Tez orada", "即将推出", "곧 출시", "In Entwicklung", "Bientôt", "近日公開", "Yakında", "قريبًا"),
