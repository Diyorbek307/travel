...
const CITIES = [
  ...
  },
  {
    ...
    text:
      "Регистан, Гур-Эмир, Шахи-Зинда, Биби-Ханым. Приложение соберёт из них " +
      "день под ваше время и интересы — с обедом по дороге.",
    stat: "14 адресов",
    accent: "#8ae9e0",
  },
  {
      ...
      <div className="mx-auto w-full max-w-6xl px-6">
        ...
        <div className="mt-12">
          ...
          <div
            ...
            style={{ background: "linear-gradient(90deg,#34dccf,#e9c46a)" }}
          />
